                                                    ...
                                                    <div class="card-block">
                                                        <h4 class="sub-title">Cad. Usuário</h4>
                                                           ...
                                                           <div class="form-group form-default form-static-label">
												            ...
												            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModalUsuario">Pesquisar</button>
...
function buscarUsuario(){
	...
	if (nomeBusca !=null && nomeBusca != '' && nomeBusca.trim() != '' ){ /* Validando que existe um valor a ser buscado no banco de dados */
